...
#define LESENSE_LCSENSE_SENSOR_CH_CONF                                                                             \
  {                                                                                                                \
    ...
    false,                    /* Enable interrupts on channel.          true */                                                   \
    lesenseChPinExHigh,       /* GPIO pin is disabled during the excitation period   lesenseChPinExLow    lesenseChPinExHigh. */                              \
    lesenseChPinIdleDACCh0,     /* GPIO pin is disabled during the idle period.      lesenseChPinIdleDACCh1 lesenseChPinIdleDis */                                    \
    ...
    true,                   /* Disabled to invert the scan result bit.           false*/                                         \
    ...
    15,                   /* Excitation time is set to 15 (+1) excitation clock cycles.           0x0FU*/                      \
    5,                   /* Sample delay is set to 2(+1) sample clock cycles.                   0x02U*/                               \
    0x00U,                   /* Measure delay is set to 0 excitation clock cycles.*/                               \
    40,                  /* ACMP threshold has been set to 0x7FF - not used, controled by the ACMP registers   ¸ÄÎª¿ØÖÆVDD£¿  0x000*/ \
    lesenseSampleModeCounter, /* Counter will be used in comparison.    lesenseSetIntPosEdge    */                                            \
    lesenseSetIntNone,    /* Interrupt is not generated if the sensor triggers. */                                  \
...
#define LESENSE_LCSENSE_SCAN_CONF                        \
  {                                                      \
    {                                                    \
      LESENSE_LCSENSE_SENSOR_CH_CONF,        /* Channel 0. */  \
      LESENSE_LCSENSE_SENSOR_CH_CONF,        /* Channel 1. */  \
